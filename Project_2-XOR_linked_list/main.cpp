...
struct list {					//struktura listy
	...
	node* actual = NULL;		//wskaŸnik na aktualny element
	node* prev = NULL;			//wskaŸnik na poprzednika aktualnego
	node* next = NULL;			//wska¿nik na natêpnika aktualnego
};
...
//DODAWANIE WÊZ£A (na pocz¹tek, na kniec, jako poprzednik actual)
...
//USUWANIE WÊZ£A (pocz¹tkowego, koñcowego, aktualnego, wszystkie z dan¹ wartoœci¹)
...
//WYPISYWANIE WÊZ£A (aktualny, nastêpnik, poprzednik)
...
//WYPISYWANIE LISTY (od przodu, od koñca)
